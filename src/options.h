...
public:
  ...
  static bool do_iterative_write_scores;
  ...
  static string ecPrivacyTrainFile;
  static string ecPrivacyHoldoutFile;
  static string ecPrivacyTestFile;
  static double ecPrivacyStartTemp;
