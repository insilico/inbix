...
bool armaComputeCovariance(arma::mat X, arma::sp_mat& covMatrix, arma::sp_mat& corMatrix);
...
bool armaWriteMatrix(arma::sp_mat& m, std::string mFilename, 
				std::vector<std::string> variableNames);
...
bool armaDcgain(arma::sp_mat& results, arma::sp_mat& pvals);
