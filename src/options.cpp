...
// added for numeric attribute support - bcw - 4/22/13
...
bool par::do_coexpression_all = false;
bool par::do_coexpression_casecontrol = false;
bool par::do_numeric_summary = false;
...
bool par::do_regain_write_sif = false;
bool par::do_regain_write_model_details = false;
string par::regainFile = "no file";
double const par::regainLargeCoefPvalue = 0.99;
double const par::regainLargeCoefTvalue = 10;
double const par::regainMaxBetaValue = 100e3;
...
uint par::relieffNumTarget = 0;
uint par::relieffIterNumToRemove = 0;
uint par::relieffIterPercentToRemove = 0;
uint par::k = 999999;
uint par::koptBegin = 1;
uint par::koptEnd = 2;
uint par::koptStep = 1;
uint par::m = 0;
...
double par::ecPrivacyStartTemp = 0.1;
