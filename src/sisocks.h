...
/* MacOS X hack (gcc on any platform should behave as unix - except for 
 * Win32, where we need to keep using winsock) */
#if defined __GNUC__ && !defined unix && !defined Win32 && !defined _WIN32
#define unix
#endif
