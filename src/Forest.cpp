...
Forest::Forest() :
    verbose_out(0), num_trees(DEFAULT_NUM_TREE), mtry(0), min_node_size(0), num_variables(0), num_independent_variables(
        ...
        1), holdout(false), alpha(DEFAULT_ALPHA), prediction_type(DEFAULT_PREDICTIONTYPE), minprop(DEFAULT_MINPROP), num_threads(DEFAULT_NUM_THREADS), data(0), overall_prediction_error(
