...
public:
   ...
   ****************************************************************************/
  virtual AttributeLevel GetAttribute(unsigned int index);
   ...
   ****************************************************************************/
  virtual NumericLevel GetNumeric(unsigned int index);
  /*************************************************************************//**
   ...
   * SIDE_EFFECT: Sorts and loads class the variables: sameSums and diffSums
   *              from the neighbors
